...
import com.jm.Edicof.Clases.Struct_personal_activo_externo;
import com.jm.Edicof.Clases.Struct_personal_activo_semanal;
import com.jm.Edicof.Clases.Struct_personal_activo_semanal_externo;
 ...
 * @author ADMIN
 */
public class Rep_personal_activo_externos extends javax.swing.JDialog {

    /**
     * Creates new form Rep_personal_activo
     */
    public Rep_personal_activo_externos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Reporte personal activo Externos");
        setResizable(false);
                ...
                if (rep_consolidado.isSelected()) {
                    try {
                        ...
                        if (cb_formato.getSelectedItem().equals(".pdf")) {
                            ...
                            fc_rep_diario.setSelectedFile(new File("Reporte_diario_consolidado_externos_"+new SimpleDateFormat("dd-MM-yyyy").format(fecha_rep)+".pdf"));
                        }
                        if (cb_formato.getSelectedItem().equals(".xls")) {
                            filter = new FileNameExtensionFilter("Archivos Excel (*.xlsx)","xlsx");
                            fc_rep_diario.setFileFilter(filter);
                            fc_rep_diario.setSelectedFile(new File("Reporte_diario_consolidado_externos_"+new SimpleDateFormat("dd-MM-yyyy").format(fecha_rep)+".xlsx"));
                        }
                        ...
                        if(fc_rep_diario.showSaveDialog(this)==JFileChooser.APPROVE_OPTION){
                            if (fc_rep_diario.getSelectedFile().exists()) {
                                ...
                                if (conf == JOptionPane.YES_OPTION) {
                                    Struct_personal_activo_externo s = new Struct_personal_activo_externo(this,fc_rep_diario.getSelectedFile().getAbsolutePath(),cb_formato.getSelectedItem().toString(), fecha_rep,fc_rep_diario.getSelectedFile().toString());
                ...
                if (rep_semanal.isSelected()) {
                    ...
                    try {
                        ...
                        if(fc_rep_remanal.showSaveDialog(this)==JFileChooser.APPROVE_OPTION){
                            Struct_personal_activo_semanal_externo s = new Struct_personal_activo_semanal_externo(this,fc_rep_remanal.getSelectedFile().getAbsolutePath(),cb_formato.getSelectedItem().toString(),fecha_rep);
                            Wait_rep t = new Wait_rep(this,true,s);
                            t.setLocationRelativeTo(null);
                            t.setVisible(true);
                            this.dispose();
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rep_personal_activo_externos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Rep_personal_activo_externos dialog = new Rep_personal_activo_externos(new javax.swing.JFrame(), true);
