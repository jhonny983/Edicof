 ...
 * @author ADMIN
 */
public class Edd_Barrio extends javax.swing.JDialog {
    TextAutoCompleter tac_barrio = null;
    /**
     * Creates new form Add_Empleado
     */
    public Edd_Barrio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public Edd_Barrio(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/group_gear.png")));
        init();
    ...
    public void init(){
        tac_barrio = new TextAutoCompleter(busc_barrio, new AutoCompleterCallback() {
        @Override
    ...
    private void initComponents() {
        ...
        busc_barrio = new javax.swing.JTextField();
        ...
        busc_barrio.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(busc_barrio)
                    .addComponent(nombre_barrio, javax.swing.GroupLayout.DEFAULT_SIZE, 347, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(busc_barrio, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!busc_barrio.getText().equals("")) {
            if (!nombre_barrio.getText().equals("")) {
                ...
                try {
                    ...
                    if(r.next()){
                        ...
                        if (conf == JOptionPane.YES_OPTION) {
                            con.s.executeUpdate("UPDATE `t_barrio` SET `NOMBRE_BARRIO`='"+nombre_barrio.getText().toUpperCase()+"' WHERE `NOMBRE_BARRIO`='"+busc_barrio.getText().toUpperCase()+"'");
                            JOptionPane.showMessageDialog(this,"El BARRIO fue modificado correctamente","Información",JOptionPane.INFORMATION_MESSAGE);
                            con.cerrar();
                            this.dispose();
                        }
                ...
                JOptionPane.showMessageDialog(this,"Digite el nuevo nombre de la BARRIO que desea modificar","Error",JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this,"Digite el nombre de la BARRIO que desea modificar","Error",JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edd_Barrio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Edd_Barrio dialog = new Edd_Barrio(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextField busc_barrio;
