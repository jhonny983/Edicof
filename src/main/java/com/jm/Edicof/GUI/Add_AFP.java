...
public class Add_AFP extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Al momento de ingresar el codigo de la AFP asegurese que este corresponda");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(codigo_afp, javax.swing.GroupLayout.PREFERRED_SIZE, 347, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (check_field (nombre_afp.getText())) {
            if (check_field (codigo_afp.getText())) {
                ...
                try {
                    ...
                    if(r.next()){
                        ...
                        r = con.s.executeQuery ("SELECT * FROM `t_afp` WHERE ID_AFP = '"+codigo_afp.getText().toUpperCase().trim()+"'");
                        if(r.next()){
                            JOptionPane.showMessageDialog(this,"La AFP que intenta ingresar ya existe","Error",JOptionPane.ERROR_MESSAGE);
                        }
                        else{
                            ...
                            if (conf == JOptionPane.YES_OPTION) {
                                con.s.executeUpdate("INSERT INTO `t_afp`(`ID_AFP`, `NOMBRE_AFP`) VALUES ('"+codigo_afp.getText().toUpperCase().trim()+"', '"+nombre_afp.getText().toUpperCase().trim()+"')");
                ...
                JOptionPane.showMessageDialog(this,"Verifique que el codigo de la AFP no este vacio ni contenga caracteres especiales.","Error",JOptionPane.ERROR_MESSAGE);
            }
            
        } else {
            JOptionPane.showMessageDialog(this,"Verifique que el nombre de la AFP no este vacio ni contenga caracteres especiales.","Error",JOptionPane.ERROR_MESSAGE);
        }
