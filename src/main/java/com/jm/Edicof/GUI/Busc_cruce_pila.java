 ...
 * @author Johnnatan
 */
public class Busc_cruce_pila extends javax.swing.JDialog {
...
Object [] fila = new Object[16];
     ...
     */
    public Busc_cruce_pila(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Busqueda de Cruce PILA");
        setResizable(false);
        ...
        // TODO add your handling code here:
            ...
            try {
                r = con.s.executeQuery ("SELECT *\n" +
                                        "FROM\n" +
                                        "    t_cruce_pila\n" +
                                        "WHERE VIGENCIA_CRUCE ='"+get_fecha_fin(mes.getMonth(),año.getYear())+"'\n" +
                                        "ORDER BY FECHA_CRUCE DESC");
            while(r.next()){
                modelo.addRow(fila);
                modelo.setValueAt(r.getString("ID_CRUCE_PILA"),cruces.getRowCount()-1,0);
                modelo.setValueAt(new SimpleDateFormat("dd-MM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(r.getString("VIGENCIA_CRUCE"))),cruces.getRowCount()-1,1);
                modelo.setValueAt(new SimpleDateFormat("dd-MM-yyyy HH:mm:ss").format(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(r.getString("FECHA_CRUCE"))),cruces.getRowCount()-1,2);
            }
            con.cerrar();
        ...
        if (cruces.getSelectedRow()!=-1) {
            ...
            try {
                r = con.s.executeQuery ("SELECT *\n" +
                                        "FROM\n" +
                                        "    t_cruce_pila\n" +
                                        "WHERE ID_CRUCE_PILA = "+cruces.getValueAt(cruces.getSelectedRow(), 0)+"\n" +
                                        "ORDER BY FECHA_CRUCE DESC");
            if(r.next()){
                ...
                fc.setSelectedFile(new File("Cruce_PILA_"+new SimpleDateFormat("dd-MM-yyyy_HH-mm-ss").format(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(r.getString("FECHA_CRUCE")))+"_.xls"));
//                fc.setSelectedFile(new File("Cruce_ARL_.xls"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Busc_cruce_pila.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Busc_cruce_pila dialog = new Busc_cruce_pila(new javax.swing.JFrame(), true);
