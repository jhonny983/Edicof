...
String SI_NO = "SI\n"
            + "NO";
String RGTARIFAARL = "NINGUNA\n" +
            "0,52%\n" +
            "1,04%\n" +
            "2,44%\n" +
            "4,35%\n" +
            "6,96%";
String RGTARIFACCF = "NINGUNA\n" +
            "0,60%\n" +
            "2,00%\n" +
            "4,00%";
String RGALTORIESGO = "SIN RIESGO\n" +
            "ALTO RIESGO\n" +
            "CTI\n" +
            "ALTO RIESGO (6%)\n" +
            "ALTO RIESGO (8.5%)\n" +
    ...
    public Add_list_novedades_pila(String path) {
        try {
            FileInputStream fis;
        ...
        //FileOutputStream fileOut = new FileOutputStream("E:/t.xls");
