 ...
 * @author ADMIN
 */
public class CellRender_vetados extends DefaultTableCellRenderer{
...
public boolean check_empleado(Object nomb){
    boolean ret=false;
    if (nomb!=null) {
        if (chech_char(nomb.toString().trim(),"'#$%&()=?¡¿/*+[]{};:<>,.")) {
            if(!nomb.toString().equals("")){
                ret=true;
            }
        }
    }
