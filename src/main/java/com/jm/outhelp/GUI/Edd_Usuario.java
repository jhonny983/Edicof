 ...
 * @author ADMIN
 */
public class Edd_Usuario extends javax.swing.JDialog {

    /**
     * Creates new form Add_Empleado
     */
    public Edd_Usuario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            if (!nombre_1.getText().equals("")) {
                if (!ape_1.getText().equals("")) {
                    if (!login.getText().equals("")) {
                        ...
                        ResultSet r;
                        try {
                            r = con.s.executeQuery ("SELECT * FROM `t_usuarios` WHERE ID_USUARIO = "+cedula.getText()+" AND ID_USUARIO <>"+cb_cedula.getSelectedItem());
                            if(r.next()){
                                JOptionPane.showMessageDialog(this,"El usuario que desea ingresar ya existe","Error",JOptionPane.ERROR_MESSAGE);
                            }else{
                                ...
                                if (conf == JOptionPane.YES_OPTION) {
                                    ...
                                    con.s.executeUpdate("UPDATE T_USUARIOS set ID_USUARIO="+cedula.getText()+", NOMBRE_USUARIO='"+nombre_1.getText().toUpperCase()+"', NOMBRE_2_USUARIO = '"+nombre_2.getText().toUpperCase()+"', APELLIDO_USUARIO='"+ape_1.getText().toUpperCase()+"', APELLIDO_2_USUARIO='"+ape_2.getText().toUpperCase()+"', USUARIO_USUARIO = '"+login.getText().toUpperCase()+"', ID_ROL = "+Id_tipo+" WHERE ID_USUARIO="+cb_cedula.getSelectedItem());
                                    JOptionPane.showMessageDialog(this,"El usuario fue modificado correctamente","Información",JOptionPane.INFORMATION_MESSAGE);
                                    con.cerrar();
                                    this.dispose();
                                }
                            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edd_Usuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Edd_Usuario dialog = new Edd_Usuario(new javax.swing.JFrame(), true);
...
public void load_data(){
    if (!cb_cedula.getSelectedItem().equals("Seleccione..")) {
        ...
        try {
            ...
            if (r.next()) {
                cedula.setText(r.getString("ID_USUARIO"));
                ...
                tipo.setSelectedItem(r.getString("NOMBRE_ROL"));
            }
            con.cerrar();
        }catch(SQLException j){
            con.cerrar();
