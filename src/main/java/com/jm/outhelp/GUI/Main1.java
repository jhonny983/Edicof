...
//                System.out.println("Url main: "+get_url_update(url_info_update));
//                System.out.println("Version main: "+get_ver_update(url_info_update));
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(statusAnimationLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(6, 6, 6)
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/WALLPAPPER_EDO2_RED_1.jpg"))); // NOI18N
        ...
        jMenuItem35.setIcon(new javax.swing.ImageIcon(getClass().getResource("/book_go.png"))); // NOI18N
        jMenuItem35.setText("Precálculo Seguridad");
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jm_asistencias, org.jdesktop.beansbinding.ELProperty.create("${enabled}"), jMenuItem26, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jToolBar1, javax.swing.GroupLayout.PREFERRED_SIZE, 1030, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        // TODO add your handling code here:
    int reply = JOptionPane.showConfirmDialog(this,"Esta seguro que desea salir?","Verificacion",JOptionPane.OK_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE);
    ...
    private void jm_cerrar_sesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jm_cerrar_sesionActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(null,"Esta seguro que desea cerrar sesion?","Confirmar",JOptionPane.OK_CANCEL_OPTION)==0){
            Main1.jm_iniciar_sesion.setEnabled(true);
            Main1.jm_cerrar_sesion.setEnabled(false);
            Main1.jm_cambio_contraseña.setEnabled(false);
            Main1.jm_novedades.setEnabled(false);
            Main1.jm_informacion.setEnabled(false);
            Main1.jm_reportes.setEnabled(false);
            Main1.jm_importar.setEnabled(false);
            Main1.jm_usuarios.setEnabled(false);
            Main1.jm_config.setEnabled(false);
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        // TODO add your handling code here:
            int resp = JOptionPane.showConfirmDialog(null,"Esta seguro que dese salir del sistema?");
...
public static Dimension getsize() {
    return Main1.size; //To change body of generated methods, choose Tools | Templates.
}
