...
import com.jm.outhelp.Clases.CellRender_Preingresos_Traslados;
...
//        tb_barrio_table = new JTextField();
        ...
        /////////////////-----------------------------------------
//        tb_cedula_table.addKeyListener(new java.awt.event.KeyAdapter() {
//            @Override
...
//                        String aux = tb_cedula_table.getText();
//    //                    System.out.println("Antes: "+aux);
//                        if (aux!=null) {
//    //                        System.out.println("aux no null");
//                            tb_cedula_table.setText(before_edit_cell);
//                            evt.setKeyCode(10);
//                        }
//                    }
//                }
...
//
//        });
//        tb_empleador_table.addKeyListener(new java.awt.event.KeyAdapter() {
//            @Override
//            public void keyPressed(java.awt.event.KeyEvent evt) {
//                char a=evt.getKeyChar();
//                int b=evt.getKeyCode();
...
//
//        });
//        tb_parentesco_table.addKeyListener(new java.awt.event.KeyAdapter() {
//            @Override
//            public void keyPressed(java.awt.event.KeyEvent evt) {
//                char a=evt.getKeyChar();
//                int b=evt.getKeyCode();
...
//
//        });
//        tb_municipio_table.addKeyListener(new java.awt.event.KeyAdapter() {
//            @Override
//            public void keyPressed(java.awt.event.KeyEvent evt) {
//                char a=evt.getKeyChar();
//                int b=evt.getKeyCode();
...
//
//        });
//        tb_obra_table.addKeyListener(new java.awt.event.KeyAdapter() {
//            @Override
//            public void keyPressed(java.awt.event.KeyEvent evt) {
//                char a=evt.getKeyChar();
//                int b=evt.getKeyCode();
