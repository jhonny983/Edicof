 ...
 * @author cogeuser
 */
public class Close_Evo_PQR extends javax.swing.JDialog {
    String rad;
    /**
     * Creates new form Add_Evo_PQR
     */
    public Close_Evo_PQR(java.awt.Frame parent, boolean modal, String r) {
        super(parent, modal);
        initComponents();
        this.rad=r;
    }
    public Close_Evo_PQR(javax.swing.JDialog parent, boolean modal, String r) {
        super(parent, modal);
        initComponents();
        this.rad=r;
    }
        ...
        if (!t_evo.getText().equals("") & !t_evo.getText().equals(" ")) {
            ...
            if (conf1 == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    con.s.executeUpdate("UPDATE `t_caso_pqr` SET `ID_ESTADO_CASO`=3 WHERE ID_CASO="+rad);
                    con.cerrar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Close_Evo_PQR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Close_Evo_PQR dialog = new Close_Evo_PQR(new javax.swing.JFrame(), true, new String());
