...
import com.jm.outhelp.Clases.Struct_nov_pila_retiro;
import com.jm.outhelp.Clases.Struct_nov_pila_retiro_emp;
 ...
 * @author ADMIN
 */
public class Rep_novedades_pila_retiro extends javax.swing.JDialog {
TextAutoCompleter tac_empleador = null;
    /**
     * Creates new form Rep_precalculo
     */
    public Rep_novedades_pila_retiro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void init(){
    ...
    private void initComponents() {
        ...
        setTitle("Reporte Novedades Pila Retiros");
        setResizable(false);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if(fc_rep_novedades_pila.showSaveDialog(this)==JFileChooser.APPROVE_OPTION){
                Struct_nov_pila_retiro s = new Struct_nov_pila_retiro(this,fc_rep_novedades_pila.getSelectedFile().getAbsolutePath(), getfirstDate(mes_nov.getMonth()+1, year_nov.getYear()), getlastDate(mes_nov.getMonth()+1, year_nov.getYear()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rep_novedades_pila_retiro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Rep_novedades_pila_retiro dialog = new Rep_novedades_pila_retiro(new javax.swing.JFrame(), true);
